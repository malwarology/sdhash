...
func computeCompareAnchors(t *testing.T, work []corpusWork) *corpusCompareAnchors {
	...
	// record slices are written without locking. Scoring uses CompareDebug
	// (default toggles), matching the sdhashtest -f tool.
	n := len(digests)
